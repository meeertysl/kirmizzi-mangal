...
const DEFAULT_DB = {
  settings: {
    ...
    about:
      "Kırmızı Mangal olarak en taze etleri, ustalıkla hazırlanan mezeleri ve geleneksel mangal lezzetlerini sofranıza getiriyoruz. Odun ateşinde, ustaların elinde pişen kebaplarımızla damaklarda iz bırakıyoruz.",
